...
public class Hooks {
    ...
    public void after(Scenario scenario){
        ...
        // Excele sonuçları yazacağız ,path,scenario,browserTipi,zaman => Örnekleriyle;
        //  ExcelUtility.writeExcel("src/test/java/ApachePOI/resource/ScenarioStatus.xlsx",scenario,GWD.threadBrowserName.get(),
